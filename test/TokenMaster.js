...
const OCCASION_COST = hre.ethers.utils.parseUnits("1", "ether");
const OCCASION_MAX_TICKETS = 100;
const OCCASION_DATE = "Apr 27";
const OCCASION_TIME = "10:00AM CST";
const OCCASION_LOCATION = "Austin, Texas";
const OCCASION_GENRE = "MUSIC";
...
describe("TokenMaster", () => {
  ...
  describe("Occasions", () => {
    it("Returns occasions attributes", async () => {
      ...
      expect(occasion.genre).to.be.equal(OCCASION_GENRE);
    });
  ...
  describe("Minting", () => {
    const ID = 1;
    const SEAT = 50;
    const AMOUNT = hre.ethers.utils.parseUnits("1", "ether");
    ...
    it("Updates the contract balance", async () => {
      const balance = await hre.ethers.provider.getBalance(tokenMaster.address);
